...
function greeting()
{
	...
	if(currentTime >= 6 && currentTime < 12)
	{
		...
		header.style = "color:blue;";						// 4. Set a color for the greeting
	}
	else
	{
		if(currentTime >= 12 && currentTime <17)
		{
			...
			header.style = "color:red;";					// 5. Set a color for the greeting	
		}
		else
		{
			header.innerHTML = "Good Evening";
			header.style = "color:lime green;";					// 6. Set a color for the greeting		
		}
	}
